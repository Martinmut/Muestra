            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/usuario/' . $usuario->id . '/edit') }}" title="Edit usuario"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Nombre </th><td> {{ $usuario->nombre }} </td></tr><tr><th> Edad </th><td> {{ $usuario->edad }} </td></tr><tr><th> Correo </th><td> {{ $usuario->correo }} </td></tr>
                                </tbody>
                            </table>
                        </div>
